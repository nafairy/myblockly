...
/* 初始化Blockly块 */
ArrayDeleteBlockly.initBlockly = function (blocklyDiv, mediaLocation,XMLpath) {
...
ArrayDeleteExecute.setBlockly = function (blocklyDiv, mediaPath, XMLpath) {
    ...
    let initworkspaceXML=ArrayDeleteBlockly.getWorkspaceXML("static/xml/arrays/array_delete_init_workspace.xml");

    // 定义Blockly工作空间
    ArrayDeleteBlockly.workspace = ArrayDeleteBlockly.initBlockly(blocklyDiv, mediaPath,workspaceXML);

    // 定义预定义块
    Blockly.Xml.domToWorkspace(initworkspaceXML, ArrayDeleteBlockly.workspace);
