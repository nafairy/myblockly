...
ArrayInsertExecute.setBlockly = function (blocklyDiv, mediaPath, XMLpath) {
    ...
    let initworkspaceXML=ArrayInsertBlockly.getWorkspaceXML("static/xml/arrays/array_insert_init_workspace.xml");
    // 定义Blockly工作空间
    ArrayInsertBlockly.workspace = ArrayInsertBlockly.initBlockly(blocklyDiv, mediaPath,workspaceXML);

    // 定义预定义块
    Blockly.Xml.domToWorkspace(initworkspaceXML, ArrayInsertBlockly.workspace);
}
