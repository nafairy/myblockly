...
/* 初始化Blockly块 */
LinkListDeleteBlockly.initBlockly = function (blocklyDiv, mediaLocation,workspaceXML) {
...
LinkListDeleteExecute.setBlockly = function (blocklyDiv, mediaPath, XMLpath) {
    ...
    let initworkspaceXML=LinkListDeleteBlockly.getWorkspaceXML("static/xml/linklists/linklist_delete_init_workspace.xml");
    // 定义Blockly工作空间
    LinkListDeleteBlockly.workspace = LinkListDeleteBlockly.initBlockly(blocklyDiv, mediaPath,workspaceXML);

    // 定义预定义块
    Blockly.Xml.domToWorkspace(initworkspaceXML, LinkListDeleteBlockly.workspace);
