...
/* 初始化Blockly块 */
LinkListSearchBlockly.initBlockly = function (blocklyDiv, mediaLocation,workspaceXML) {
...
LinkListSearchExecute.setBlockly = function (blocklyDiv, mediaPath, XMLpath) {
    ...
    let initworkspaceXML=LinkListSearchBlockly.getWorkspaceXML("static/xml/linklists/linklist_search_init_workspace.xml");
    // 定义Blockly工作空间
    LinkListSearchBlockly.workspace = LinkListSearchBlockly.initBlockly(blocklyDiv, mediaPath,workspaceXML);

    // 定义预定义块
    Blockly.Xml.domToWorkspace(initworkspaceXML, LinkListSearchBlockly.workspace);
