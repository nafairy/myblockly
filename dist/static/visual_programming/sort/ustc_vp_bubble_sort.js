...
/* 初始化Blockly块 */
BubbleSortBlockly.initBlockly = function (blocklyDiv, mediaLocation,workspaceXML) {
...
BubbleSortExecute.setBlockly = function (blocklyDiv, mediaPath, XMLpath) {
    ...
    let initworkspaceXML=BubbleSortBlockly.getWorkspaceXML("static/xml/arrays/bubble_sort_init_workspace.xml");
    // 定义Blockly工作空间
    BubbleSortBlockly.workspace = BubbleSortBlockly.initBlockly(blocklyDiv, mediaPath,workspaceXML);

    // 定义预定义块
    Blockly.Xml.domToWorkspace(initworkspaceXML, BubbleSortBlockly.workspace);
