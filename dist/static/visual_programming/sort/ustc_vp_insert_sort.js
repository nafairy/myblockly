...
/* 初始化Blockly块 */
InsertSortBlockly.initBlockly = function (blocklyDiv, mediaLocation,workspaceXML) {
...
InsertSortExecute.setBlockly = function (blocklyDiv, mediaPath, XMLpath) {
    ...
    let initworkspaceXML=InsertSortBlockly.getWorkspaceXML("static/xml/arrays/insert_sort_init_workspace.xml");
    // 定义Blockly工作空间
    InsertSortBlockly.workspace = InsertSortBlockly.initBlockly(blocklyDiv, mediaPath,workspaceXML);

    // 定义预定义块
    Blockly.Xml.domToWorkspace(initworkspaceXML, InsertSortBlockly.workspace);
