...
/* 初始化Blockly块 */
QueueOverAllBlockly.initBlockly = function (blocklyDiv, mediaLocation, workspaceXML) {
...
QueueOverAllExecute.setBlockly = function (blocklyDiv, mediaPath, XMLpath) {
    ...
    // 定义Blockly工作空间
    QueueOverAllBlockly.workspace = QueueOverAllBlockly.initBlockly(blocklyDiv, mediaPath,workspaceXML);

    let initworkspaceXML=QueueOverAllBlockly.getWorkspaceXML("static/xml/queues/queue_overall_init_workspace.xml");

    Blockly.Xml.domToWorkspace(initworkspaceXML, QueueOverAllBlockly.workspace);
